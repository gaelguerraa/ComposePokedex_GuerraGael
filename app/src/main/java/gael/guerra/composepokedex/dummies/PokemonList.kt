...
val pokemonList = listOf(
    Pokemon("Pikachu", 25, "Eléctrico", "Un Pokémon eléctrico muy ágil.", 0.4f, 6.0f, true, "Estática", R.drawable.pikachu),
    Pokemon("Charmander", 4, "Fuego", "Prefiere lugares calientes.", 0.6f, 8.5f, false, "Mar Llamas", R.drawable.charma),
    Pokemon(
